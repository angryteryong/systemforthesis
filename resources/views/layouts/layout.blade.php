<html lang='en'>
	...
	<body>
		<div class='container-fluid mainContainer'>
			<nav class="navbar navbar-default navbar-fixed-top device-fixed-height">
		      <div class="container">
			    ...
			    @if(session('go') == 0)
				 	<ul class="nav navbar-nav navbar-right">
				      <li><a href="/register"><span class="glyphicon glyphicon-user"></span> Register Your Company </a></li>
				    </ul>
	   			@else
		   			<div id="navbar" class="collapse navbar-collapse device-fixed-width">
			          <form style="margin-top: 8px;" method="get" action="/search" id="searchForm" class="navbar-form navbar-left">
						     {{ csrf_field() }}
			    ...
			    @if(session('crequests') + session('crecommendations') != 0)
