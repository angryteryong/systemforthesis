		...
		<div class="col-sm-6">
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<form class="form-horizontal" method="post" action="/editaccount" data-toggle="validator" enctype="multipart/form-data">
						{{ csrf_field() }}
						{{ method_field('patch') }}
					  <div class="form-group">
					    <label class="control-label col-sm-4" for="username">Username:</label>
					    <div class="col-sm-8">
					      <input type="text" class="form-control" id="username" placeholder="Username" value="{{ $sc->username }}" disabled>
					    </div>
					  </div>
					  <div class="form-group">
					  ...
					  <div class="form-group"> 
					  		<label for="photo" class="control-label col-sm-4">School's Logo:</label>
							<div class="col-sm-8">
							   <input type="file" class='btn file' name='photo' id="photo">
							</div>
				 		</div>
					  <div class="form-group">
